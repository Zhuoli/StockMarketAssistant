...
public class CompanyRecord extends UpdatableRecordImpl<CompanyRecord> implements Record15<String, byte[], Double, Timestamp, Double, Double, Double, Double, Double, Double, Double, Double, Integer, Integer, Timestamp> {

    private static final long serialVersionUID = 92144780;
     ...
     */
    public void setCompanyname(byte[] value) {
        set(1, value);
    }
     ...
     */
    @Override
    public Row15<String, byte[], Double, Timestamp, Double, Double, Double, Double, Double, Double, Double, Double, Integer, Integer, Timestamp> fieldsRow() {
     ...
     */
    @Override
    public Row15<String, byte[], Double, Timestamp, Double, Double, Double, Double, Double, Double, Double, Double, Integer, Integer, Timestamp> valuesRow() {
     ...
     */
    @Override
    public CompanyRecord value2(byte[] value) {
     ...
     */
    @Override
    public CompanyRecord value15(Timestamp value) {
     ...
     */
    @Override
    public CompanyRecord values(String value1, byte[] value2, Double value3, Timestamp value4, Double value5, Double value6, Double value7, Double value8, Double value9, Double value10, Double value11, Double value12, Integer value13, Integer value14, Timestamp value15) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public CompanyRecord(String stockid, byte[] companyname, Double currentprice, Timestamp currentpricetimestamp, Double openprice, Double closeprice, Double marketcap, Double capitalizationvalue, Double tradingvolume, Double tradingvalue, Double oscillation, Double turnoverrate, Integer pbr, Integer per, Timestamp lastupdatedatetime) {
        super(Company.COMPANY);
